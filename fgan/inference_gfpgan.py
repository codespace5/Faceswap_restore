...
def main_inferene():
    ...
    # parser = argparse.ArgumentParser()
    args = parser.parse_args()
    args.__setattr__('input', 'fgan/inputs/whole_imgs')
    ...
    for img_path in img_list:
        ...
        # input_img = cv2.imread('fgan' + img_path, cv2.IMREAD_COLOR)
        input_img = cv2.imread('fgan/inputs/whole_imgs/image.jpg', cv2.IMREAD_COLOR)
        ...
        if restored_img is not None:
            ...
            print("path_restore",os.path.abspath(os.curdir))
            cv2.imwrite('test1.jpg', restored_img)
